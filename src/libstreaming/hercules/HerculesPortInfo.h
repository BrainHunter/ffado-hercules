...
#ifndef __FFADO_HERCULESPORTINFO__
#define __FFADO_HERCULESPORTINFO__
...
//    };
    ...
    /**
     * Initialize Hercules portinfo
     * should not be called directly, is inherited by Hercules ports
     *
     ...
     * @return
     */
    HerculesPortInfo( int position, int size)
      : m_position(position), m_size(size)
    {};
    virtual ~HerculesPortInfo() {};
...
#endif /* __FFADO_HERCULESPORTINFO__ */
